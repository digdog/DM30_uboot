			    ...
			    struct mtd_oob_ops *ops)
{
	...
	debug("%s: mtd->ecc_stats.failed %d, stats.failed %d\n",
		__func__, mtd->ecc_stats.failed, stats.failed);

	if (mtd->ecc_stats.failed - stats.failed)
		return -EBADMSG;

	debug("%s: mtd->ecc_stats.corrected %d,  stats.corrected %d\n",
		__func__, mtd->ecc_stats.corrected, stats.corrected);
