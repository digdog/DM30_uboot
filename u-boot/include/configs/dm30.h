 ...
 * GPIO
 */
#define DM30_KEY_LSHIFT 	PINID_AUART1_RX
#define DM30_KEY_CTRL		PINID_AUART1_TX
#define DM30_KEY_ALT		PINID_AUART1_CTS
#define DM30_KEY_RSHIFT		PINID_AUART1_RTS
#define DM30_KEY_BATDOOR	PINID_PWM2
#define DM30_KEY_RCTRL		PINID_GPMI_D14		//add by cyliang@20171109
...
#define DM30_DDR_OFFSET_USER_PROGRAM   (0x40000000)
#define DM30_DDR_OFFSET_DATABASE       (0x40800000)
#define DM30_DDR_OFFSET_HEAP           (0x43000000)

#define DM30_DDR_SIZE_USER_PROGRAM     (DM30_DDR_OFFSET_DATABASE - DM30_DDR_OFFSET_USER_PROGRAM)
#define DM30_DRR_SIZE_DATABASE         (DM30_DDR_OFFSET_HEAP - DM30_DDR_OFFSET_DATABASE)
#define DM30_DDR_SIZE_HEAP             (0x48000000 - DM30_DDR_OFFSET_HEAP)

/* size */
#define DM30_FLASH_SIZE_BOOTLOADER        (SZ_8M - SZ_8K) // 8K means the start 16 sections before the first partions.
#define DM30_FLASH_SIZE_USER_PROGRAM      SZ_16M
#define DM30_FLASH_SIZE_DATABASE          (177 * SZ_1M) //177M
#define DM30_FLASH_SIZE_RESERVE           (55 * SZ_1M)
#define DM30_FLASH_SIZE_FILESYSTEM1       SZ_512M
#define DM30_FLASH_SIZE_FILESYSTEM2       SZ_7556M

/* offset */
#define DM30_FLASH_OFFSET_BOOTLOADER        0
#define DM30_FLASH_OFFSET_USER_PROGRAM      (DM30_FLASH_OFFSET_BOOTLOADER   + DM30_FLASH_SIZE_BOOTLOADER)
#define DM30_FLASH_OFFSET_DATABASE          (DM30_FLASH_OFFSET_USER_PROGRAM + DM30_FLASH_SIZE_USER_PROGRAM)
#define DM30_FLASH_OFFSET_RESERVE           (DM30_FLASH_OFFSET_DATABASE     + DM30_FLASH_SIZE_DATABASE)
#define DM30_FLASH_OFFSET_FILESYSTEM1       (DM30_FLASH_OFFSET_RESERVE      + DM30_FLASH_SIZE_RESERVE)
#define DM30_FLASH_OFFSET_FILESYSTEM2       (DM30_FLASH_OFFSET_FILESYSTEM1  + DM30_FLASH_SIZE_FILESYSTEM1) 

#define CONFIG_DM30_POWER
