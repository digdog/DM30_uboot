...
{
	printf("\n\n%s\n\n", version_string);
	pr_info("U-Boot code: %08lX -> %08lX  BSS: -> %08lX\n",
...
void start_armboot (void)
{
	...
	unsigned long __attribute__((unused)) addr;
#endif
...
#ifdef CONFIG_MXS_KPD
	/* the patching key(c+8) could be detected right after keyboard
	 * initialed */
	init_func_i2c();
...
#if defined(CONFIG_CMD_NAND) || defined(CONFIG_MX23_NAND_DMA)
	puts ("NAND:  ");
